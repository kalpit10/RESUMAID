  ...
  return (
    <div>
      ...
      <div id="div2" className="position-relative">
        <video
          src={require("./resumaidvideoreal.ogg")}
          autoPlay
          muted
          loop
      ...
      <div id="div3" className="position-relative">
        ...
        >
          ...
          <div className="carousel-inner d-inline-flex justify-content-center align-items-center">
             
            <div className="carousel-item active " data-bs-interval={2000}>
              <img
              onClick={()=>navigate(`/templates/1`)}

                src={require("../resources/template/template1.jpg")}
                className="d-block w-40 caraouselimg hover"
                alt="..."
              />
             </div>
            ...
            <img
             onClick={()=>navigate(`/templates/4`)}
                src={require("../resources/template/template4.jpg")}
                className="d-block w-40 caraouselimg hover"
                alt="..."
              /> 
            </div>
           ...
           <div className="carousel-item" data-bs-interval={2000}>
            ...
            onClick={()=>navigate(`/templates/6`)}
                src={require("../resources/template/template6.jpg")}
                className="d-block w-40 caraouselimg hover"
                alt="..."
              />
            </div>
        ...
        <div className="row row-cols-1 row-cols-md-3 g-4 pt-4 px-5 py-3">
          {/*    <div className="col">
                  <div className="card h-100">
                    <img src={require("./testimage.jpeg")} className="card-img-top" alt="..." />
            ...
            <div className="card h-100">
              ...
              <div className="card-body font">
                ...
                <p className="card-text font">
                 Upload your Resume in .docx format and upload it to get your score and suggestions
                </p>
                <button
                  type="button"
          ...
          <div className="col">
            <img class="div4img mt-5" src={require("./div4img.jpeg")} alt="" />
          </div>
        </div>
      </div>
              ...
              <div className="col-lg-4 col-md-5 mb-4 mb-md-0">
                ...
                <ul className="list-unstyled mb-0">
                  <li>
                    ...
                    <a href="https://www.linkedin.com/in/lishika-goel-1638b5205/" className="text-white font footericons">
                    <iconify-icon icon="bi:linkedin"></iconify-icon>
                    </a>
                  </li>
                  <li>
                    <br></br><p className="font">Kalpit Swami</p>
                    <a href="https://www.linkedin.com/in/kalpit-swami-7a4554204/" className="text-white font footericons">
                    <iconify-icon icon="bi:linkedin"></iconify-icon>
                    </a>
                  </li>
                  <li>
                    <br /><p className="font">Mantra Manas Acharya</p>
                    <a href="https://www.linkedin.com/in/manas-acharya-971aaa219/" className="text-white font footericons">
                    <iconify-icon className="footericons" icon="bi:linkedin"></iconify-icon>
                    </a>
                  </li>
